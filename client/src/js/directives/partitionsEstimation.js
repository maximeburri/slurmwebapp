angular
    .module('RDash')
    .directive('swaPartitionsEstimation', ['User', 'Files', '$modal','$compile', swaPartitionsEstimation]);

function swaPartitionsEstimation(User, Files, $modal, $compile) {
    var directive = {
        restrict: 'AE',
        scope: { selected:'='/*selectable:'@', selectableTypes:'@', tableStyle:'@'*/},
